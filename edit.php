            ...
            <form action="" method="post">
              ...
              <form class="row g-3">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="category"  placeholder="New Exam Category" value="<?php  echo $category;  ?>">
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="name">Exam time in Minutes</label>
                  <input type="text" class="form-control" name="examtime"  placeholder="Exam time in Minutes" value="<?php echo $examtime; ?>">
                </div>
                
                <div class="text-center">
                  <input type="submit" class="btn btn-primary w-100" value="Update Exam" name="submit" style="margin-top: 15px;"> 
                 </div>
              </form><!-- Vertical Form --> 
            </form>  
            </div>
